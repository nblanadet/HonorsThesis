...
temporal_data %>%
  ...
  labs(title = "δD of Cores and Twigs", x = "Sampling Date", y = "δD (‰)") +
  theme_pubclean() +
...
temporal_data %>%
  ...
  geom_boxplot() +
  stat_compare_means(method = "t.test") +
  labs(title = "δ18O of Cores and Twigs", x = "Sampling Date", y = "δ18O (‰)") +
  theme_pubclean() +
  scale_color_wsj(name = "Sample Type") +
...
temporal_data %>%
  ...
  geom_boxplot() +
  stat_compare_means(method = "t.test") +
  labs(title = "δD of cores from resprouts and non-resprouts", x = "Date", y = "δD (‰)") +
  theme_pubclean() +
...
temporal_data %>%
  ...
  geom_boxplot() +
  stat_compare_means(method = "t.test") +
  labs(title = "δ18O of cores from resprouts and non-resprouts", x = "Date", y = "δ18O (‰)") +
  theme_pubclean() +
  scale_color_wsj(name = "Plant Type") +
...
temporal_data %>%
  ...
  geom_boxplot() +
  stat_compare_means(method = "t.test") +
  labs(title = "δD of twigs from resprouts and non-resprouts", x = "Date", y = "δD (‰)") +
  theme_pubclean() +
  scale_color_wsj(name = "Plant Type") +
...
temporal_data %>%
  ...
  geom_boxplot() +
  stat_compare_means(method = "t.test") +
  labs(title = "δ18O of twigs from resprouts and non-resprouts", x = "Date", y = "δ18O (‰)") +
  theme_pubclean() +
  scale_color_wsj(name = "Plant Type") +
...
temporal_data %>%
  ...
  geom_boxplot() +
  stat_compare_means(method = "t.test") +
  labs(title = "δD of Cores and Twigs from Non-Resprouts", x = "Sampling Date", y = "δD (‰)") +
  theme_pubclean() +
  scale_color_wsj(name = "Sample Type") +
...
temporal_data %>%
  ...
  geom_boxplot() +
  stat_compare_means(method = "t.test") +
  labs(title = "δD of Cores and Twigs from Resprouts", x = "Sampling Date", y = "δD (‰)") +
  theme_pubclean() +
  scale_color_wsj(name = "Sample Type") +
...
temporal_data %>%
  ...
  geom_boxplot() +
  stat_compare_means(method = "t.test") +
  labs(title = "δ18O of Cores and Twigs from Non-Resprouts", x = "Sampling Date", y = "δ18O (‰)") +
  theme_pubclean() +
  scale_color_wsj(name = "Sample Type") +
  ggsave("temporal_core_twig_not_resprout_d18O.png", 
         path = "C:/Users/nblan/Desktop/Honors_Project/R/Graphs", 
         height = 6, 
         width = 6)
...
temporal_data %>%
  ...
  geom_boxplot() +
  stat_compare_means(method = "t.test") +
  labs(title = "δ18O of Cores and Twigs from Resprouts", x = "Sampling Date", y = "δ18O (‰)") +
  theme_pubclean() +
  scale_color_wsj(name = "Sample Type") +
  ggsave("temporal_core_twig_resprout_d18O.png", 
         path = "C:/Users/nblan/Desktop/Honors_Project/R/Graphs", 
         height = 6, 
         width = 6)
```
...
new_water_data %>%
  ...
  ggplot(aes(x = dO, y = dD, col = full_sample_type)) +
    ...
    labs(title = "δD and δ18O of twig samples", x = "δ18O (‰)", y = "δD (‰)") +
